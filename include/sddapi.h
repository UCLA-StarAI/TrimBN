...
typedef struct esdp_manager_t EsdpManager;
...
// ESDP
EsdpManager* esdp_manager_new(SddNode* node, SddManager* sdd_manager, SddWmc* literal_weights);
void esdp_manager_free(EsdpManager* manager);
SddWmc compute_mpa(EsdpManager* manager, SddLiteral d, SddWmc T, SddLiteral xy_pos, SddLiteral y_pos, SddWmc* eca);
